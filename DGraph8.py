...
G.add_edges_from([(1, 3), (1, 4), (2, 7), (3, 5), (3, 6), (3, 7), (4, 6), (4, 7), (4, 8), (5, 4), (6, 5), (8, 3), (8, 7)])

start_time = time.time()

# Find the minimum vertex cover, S
S = dnx.min_vertex_cover(G, sampler=sampler, lagrange=5, num_reads=10, label='MVC-8')
